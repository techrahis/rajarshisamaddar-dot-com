    ...
    <SectionContainer>
      <header className="z-40 bg-transparent py-5 md:py-10">
        <div className="mx-auto flex max-w-5xl items-center justify-between">
          ...
          <motion.div className="flex items-center space-x-3 text-base leading-5">
            <motion.div
              initial="hidden"
              animate="visible"
              variants={FadeContainer}
              className="hidden space-x-5 sm:flex"
            >
              {headerNavLinks.map(({ title, href }) => {
                ...
                return (
                  ...
                  >
                    <motion.span
                      variants={popUp}
                      className="font-bold tracking-wide text-gray-900 dark:text-gray-100"
                    >
                      {title}
                    </motion.span>
                  </Link>
