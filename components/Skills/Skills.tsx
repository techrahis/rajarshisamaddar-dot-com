      ...
      <div className="movieScroll mx-auto max-w-3xl px-4 sm:px-9 xl:max-w-5xl xl:px-0">
        <div className="mt-10">
          <h1 className="mb-10 text-2xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-3xl sm:leading-10 md:text-4xl md:leading-14">
            My Top <span className="text-sky-500">Skills</span>
          </h1>
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            {skills.map((skill, index) => {
              ...
              return (
                <motion.div
                  ...
                  key={index}
                  title={skill.name}
                  className="dark:bg-darkPrimary group flex origin-center transform items-center justify-center gap-4 rounded-sm border border-gray-200 border-opacity-50 bg-opacity-50 p-4 hover:bg-gray-200 dark:border-gray-800 dark:hover:bg-gray-800 sm:justify-start md:origin-top"
                >
                  ...
                  <p className="pointer-events-none hidden select-none text-sm font-medium sm:inline-flex md:text-base">
                    {skill.name}
                  </p>
                </motion.div>
              );
