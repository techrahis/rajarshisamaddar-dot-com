  ...
  return (
    <MainLayout>
      <div className="space-y-2 pt-6 pb-8 md:space-y-5 ">
        ...
        <p className="prose max-w-none text-lg font-medium dark:prose-dark">
          I offer a comprehensive range of services to meet your digital needs. With a strong focus
          on web development and design, I'm here to help you create exceptional digital experiences
          that drive success. Explore my services below:
        </p>
        {/* web development */}
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Web Development</h2>
        <p className="prose max-w-none text-lg font-medium dark:prose-dark">
        ...
        <ol className="prose max-w-none text-lg font-medium dark:prose-dark">
